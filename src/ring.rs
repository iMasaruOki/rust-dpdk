...
pub unsafe fn create(name: &'static str,
                     count: u32,
                     socket_id: i32,
                     flags: u32) -> *mut ffi::rte_ring {
    ffi::rte_ring_create(CString::new(name).unwrap().into_raw(),
...
impl ffi::rte_ring {
    ...
    pub unsafe fn do_enqueue_sp(&mut self, objs: *const *mut c_void, n: u32)
                            -> u32 {
