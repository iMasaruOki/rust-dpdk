...
pub unsafe extern "C" fn rte_get_master_lcore()-> u32 {
    (*rte_eal_get_configuration()).master_lcore
}

pub unsafe extern "C" fn rte_lcore_is_enabled(lcore_id: u32) -> bool {
...
pub unsafe extern "C" fn rte_get_first_lcore(skip_master: bool) -> u32 {
    let mut i = 0u32;
...
pub unsafe extern "C" fn rte_get_next_lcore(prev: u32, skip_master: bool,
                                            wrap: bool) -> u32 {
    let mut i = prev + 1;
    if wrap == true {
        i %= RTE_MAX_LCORE;
